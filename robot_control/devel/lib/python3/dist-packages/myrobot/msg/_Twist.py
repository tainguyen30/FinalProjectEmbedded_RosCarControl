...
"""autogenerated by genpy from myrobot/Twist.msg. Do not edit."""
import codecs
import sys
...
float64 z"""
  ...
  _slot_types = ['myrobot/Vector3','myrobot/Vector3']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.linear is None:
        self.linear = myrobot.msg.Vector3()
      if self.angular is None:
        self.angular = myrobot.msg.Vector3()
    else:
      self.linear = myrobot.msg.Vector3()
      self.angular = myrobot.msg.Vector3()
