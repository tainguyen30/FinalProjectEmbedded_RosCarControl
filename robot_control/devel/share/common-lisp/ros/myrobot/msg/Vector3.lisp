...
(cl:defmethod cl:initialize-instance :after ((m <Vector3>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vector3)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myrobot-msg:<Vector3> is deprecated: use myrobot-msg:Vector3 instead.")))
...
(cl:defmethod z-val ((m <Vector3>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myrobot-msg:z-val is deprecated.  Use myrobot-msg:z instead.")
  (z m))
